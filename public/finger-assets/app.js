...
function sampleAcquired(s){   
            ...
            // Get samples from the object - get 0th element of samples as base 64 encoded PNG image         
                ...
                var codFingerSuccess = document.getElementById('codFingerSuccess');
                codFingerSuccess.append(samples[0]); 
                // codFingerSuccess.append(Fingerprint.b64UrlTo64(samples[0]));
                console.log('samples');
                
                var fingervalue = document.getElementById('fingervalue');
                document.getElementById('fingervalue').value = Fingerprint.b64UrlTo64(samples[0]);
                ...
                var codFingerSuccess = document.getElementById('codFingerSuccess');
                codFingerSuccess.append(Fingerprint.b64UrlTo64(decodedData.Data)); 
                ...
                var codFingerSuccess = document.getElementById('codFingerSuccess');
                // var fingervalue = document.getElementById('fingervalue');
                codFingerSuccess.append(sampleData); 
                document.getElementById('fingervalue').value = sampleData;
